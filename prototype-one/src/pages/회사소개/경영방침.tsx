...
function 경영방침() {
  ...
  <div>
    ...
    <div className="box"><img src={logo} className='logo'></img></div>
    <div className='box1'>
      <table className='miniboxes1'>
        <tr>
          <p className='p1'><img src={worker}></img> 1. 고객 최우선</p>
        </tr>
        <tr>
          <p className='p1'><img src={stonks}></img> 2. 경쟁력 강화</p>
        </tr>
        <tr>
        <p className='p1'><img src={tech}></img> 3. 미래차 신성장동력 확보</p>
        </tr>
      </table>
    </div>
    ...
    <div className='box2'>
      <table className='miniboxes2'>
        <tr>
          <p className='p2'>1. 국내외 모든 환경법규의 요구 준수 및 사내 환경 요구 조건 만족</p>
        </tr>
        <tr>
          <p className='p2'>2. 환경의식 확산과 사내 환경 개선을 통한 환경경영 체계 정립</p>
        </tr>
        <tr>
          <p className='p2'>3. 생산과정에서의 오염물질을 근원적으로 감소시키기 위한 청정 생산기술 확보</p>
        </tr>
        <tr>
