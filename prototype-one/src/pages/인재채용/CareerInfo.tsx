      ...
      <Accordion.Item eventKey="1"  className='accordian3by3item'>
        ...
        <Accordion.Body>
          <Card className='card3by3'>
            <Card.Body>
            <Card.Title className='threecardtitle'>선행검증</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Body>
            <Card.Title className='threecardtitle'>개발</Card.Title>
            <Card.Text className='threecardtext'>
      ...
      <Accordion.Item eventKey="1"  className='accordian3by3item'>
        ...
        <Accordion.Body>
          <Card className='card3by3'>
            ...
            <Card.Body>
            <Card.Title className='threecardtitle'>인사/노무</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>재경</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>안전/보건/환경</Card.Title>
            <Card.Text className='threecardtext'>
      ...
      <Accordion.Item eventKey="1"  className='accordian3by3item'>
        ...
        <Accordion.Body>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>신차품질</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>양산품질</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>시험</Card.Title>
            <Card.Text className='threecardtext'>
      ...
      <Accordion.Item eventKey="1"  className='accordian3by3item'>
        <Accordion.Header className='accordian3by3head'>
          ...
          <img src={생산팀} className='threebythreeicons'></img>
            <Card.Body>
            <Card.Title className='threecardtitle'>생산(영업)팀</Card.Title>
            <Card.Text className='threecardtext'>
            고객이 만족하는 제품을 공급하기 위해 품질경영시스템을 운영, 설계 및 개발단계에서 양산까지 보증품질에 대해
            체계적인 관리를 이행하는 직무 입니다. 
            </Card.Text>
        ...
        <Accordion.Body>
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>생산</Card.Title>
            <Card.Text  className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>생산관리</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>생산기술</Card.Title>
            <Card.Text className='threecardtext'>
          ...
          <Card className='card3by3'>
            <Card.Img variant="top" src="holder.js/100px180" />
            <Card.Body>
            <Card.Title className='threecardtitle'>설비관리</Card.Title>
            <Card.Text className='threecardtext'>
